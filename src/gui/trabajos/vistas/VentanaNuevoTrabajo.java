...
//        String areas=txtArea.getText();
//        String duracionS=txtDuracion.getText();
//        String fechaP=txtFechaPresentacion.getText();
//        String fechaA=txtFechaAprobacion.getText();
...
//        
//        LocalDate fechaPre= LocalDate.parse(fechaP, format);
//        LocalDate fechaAp= LocalDate.parse(fechaA, format);
//        LocalDate fechaFin= LocalDate.parse(fechaF, format);
//        
////        Trabajo unTrabajo=new Trabajo(titulo, areas, duracion, fechaPre, fechaFin, fechaFin);
//        
